# Generated by Django 5.1.2 on 2024-11-20 10:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departure_time', models.DateTimeField(default=datetime.datetime(2024, 11, 20, 10, 24, 52, 576232, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('train', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tickets', to='railway.train')),
            ],
        ),
        migrations.CreateModel(
            name='TankWagon',
            ...
            options={
                'abstract': False,
                'constraints': [models.UniqueConstraint(fields=('train', 'number'), name='unique_tankwagon_number_per_train')],
            },
        ),
        migrations.CreateModel(
            name='SVWagon',
            ...
            options={
                'abstract': False,
                'constraints': [models.UniqueConstraint(fields=('train', 'number'), name='unique_svwagon_number_per_train')],
            },
        ),
        migrations.CreateModel(
            name='SittingWagon',
            ...
            options={
                'abstract': False,
                'constraints': [models.UniqueConstraint(fields=('train', 'number'), name='unique_sittingwagon_number_per_train')],
            },
        ),
        migrations.CreateModel(
            name='PlatzWagon',
            ...
            options={
                'abstract': False,
                'constraints': [models.UniqueConstraint(fields=('train', 'number'), name='unique_platzwagon_number_per_train')],
            },
        ),
        migrations.CreateModel(
            name='CoupeWagon',
            ...
            options={
                'abstract': False,
                'constraints': [models.UniqueConstraint(fields=('train', 'number'), name='unique_coupewagon_number_per_train')],
            },
        ),
    ]
